/**
 * AtuaHTTP Tests — HTTP Server via MessagePort
 */
import { describe, it, expect } from 'vitest';
import { AtuaHTTPServer, createHTTPServer, getHTTPModuleSource } from './AtuaHTTP.js';
import type { SerializedHTTPRequest } from './AtuaHTTP.js';

describe('AtuaHTTPServer', () => {
  it('creates a server with handler', () => {
    const server = createHTTPServer((req, res) => {
      res.end('hello');
    });
    expect(server).toBeInstanceOf(AtuaHTTPServer);
  });
