...
describe('AtuaTerminal — Construction', () => {
  it('creates with default dimensions', () => {
    const t = new AtuaTerminal();
  ...
  it('creates with custom dimensions', () => {
    const t = new AtuaTerminal({ cols: 120, rows: 40 });
...
describe('AtuaTerminal — Write/Output', () => {
...
describe('AtuaTerminal — Event System', () => {
