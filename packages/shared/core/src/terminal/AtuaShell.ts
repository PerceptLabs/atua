/**
 * AtuaShell — Interactive shell with builtins, history, tab completion
 *
 * Runs inside AtuaTerminal, provides:
...
export class AtuaShell {
  ...
  constructor(terminal: AtuaTerminal, config: ShellConfig = {}) {
